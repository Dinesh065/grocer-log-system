...
const registerUser = asyncHandler(async (req, res,) => {
    ...
    // validation(Means weather user has not kept the any empty field or entered invalid email or like other validations)
    // check if user already exist: check through username, email
    ...
    // }  //similarly u check for other fields
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    const options = {
        httpOnly: true,
        secure: true    //This will allow only server to modify the cookie 
    }
